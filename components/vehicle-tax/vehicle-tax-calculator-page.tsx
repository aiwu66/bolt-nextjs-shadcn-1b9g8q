...
import { VehicleTaxTips } from "./vehicle-tax-tips";
import { VehicleTaxDeductionGuide } from "./vehicle-tax-deduction-guide";
...
export function VehicleTaxCalculatorPage() {
          ...
          <Card className="p-6">
            <Tabs value={activeTab} onValueChange={setActiveTab}>
              <TabsList className="grid w-full grid-cols-5">
                ...
                <TabsTrigger value="deduction">抵扣指南</TabsTrigger>
